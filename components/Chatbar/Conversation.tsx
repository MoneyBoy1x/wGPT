  ...
  return (
    <div className="relative flex items-center">
      {isRenaming && selectedConversation.id === conversation.id ? (
        <div className="flex w-full items-center gap-3 bg-[#101A27]/90 p-3">
          <IconMessage size={18} />
          <input
        ...
        <button
          className={`birder flex w-full cursor-pointer items-center gap-3 rounded-lg p-3  text-sm text-white/90 transition-colors duration-200 hover:bg-[#343541]/90 ${
